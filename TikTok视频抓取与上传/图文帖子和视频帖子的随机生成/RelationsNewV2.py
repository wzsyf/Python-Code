    ...
    def UpdateRelations(self, email, pwd, flags=[], minScore=0.4, flag=None, limit=-1):
        ...
        for post in postsNeedUpdate:
            ...
            if len(productsSimilar) > 0:
                ...
                # 将图文帖子添加到帖子Id数组
                self.postImageIdDic[email] = postId
...
if __name__ == "__main__":
    ...
    for postIdKey in postIdKeys:
        ...
        postImageId = postImageIdMap.get(postIdKey)

        if postImageId is None:
            ...
            Voila.AddFlagToPost(postImageId, "popular-post")
            rn.postsEnable(postIdKey, "demo", postImageId)